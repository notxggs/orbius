...
const CATEGORY_DATA = {
        ...
        utility: {
                ...
                commands: [
                        ['premium',     'Shows information about Orbius Premium'],
        ...
        contact: {
                title: 'Contact us',
                description: 'Contact us in case of bug report or feedback or suggestions by joining our **[Support Server](https://discord.gg/NotX)**',
                commands: [],
        },
};
...
class HelpCommand extends Command {
        ...
        _buildButtons() {
                return new ActionRowBuilder().addComponents(
                        ...
                        new ButtonBuilder()
                                .setLabel('Support')
                                .setURL(config.links?.supportServer || 'https://discord.gg/NotX')
                                .setStyle(ButtonStyle.Link),
                );
        }
        ...
        _buildMainView(prefix) {
                ...
                container.addTextDisplayComponents(
                        new TextDisplayBuilder().setContent('### Orbius bot help panel'),
                );
...
` +
                                `${emoji.arrow} NotX Development reached to another milestone!
` +
                                `${emoji.arrow} Join NotX and upgrade your experience.
 ...
 * GitHub: https://github.com/NotXDevs
 * License: Custom
 *
